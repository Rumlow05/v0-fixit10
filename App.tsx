        ...
        <div className="space-y-2">
          ...
          {currentUser?.email === "tech@emprendetucarrera.com.co" && (
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left font-medium transition-all duration-200 text-gray-700 hover:bg-gray-100"
            >
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {(users || []).map((user) => (
            <tr key={user.id}>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{user.phone || 'No especificado'}</td>
